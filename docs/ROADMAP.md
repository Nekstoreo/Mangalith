...
**Próximo paso**: Fase 1 - Gestión de Contenido + Lector
...
**Objetivo**: Sistema funcional para subir manga y leerlo con interfaz profesional.

**Duración estimada**: 6-10 semanas  
**Prioridad**: Crítica (Core del producto)

### Sprint 1.1: Modelo de Datos y API Base (Semana 1-2)

**Objetivo**: Backend puede crear y recuperar series y capítulos.

**Tareas**:
- [ ] **Backend - Domain Layer**
  - [ ] Crear entidad `Series` con value objects
  - [ ] Crear entidad `Chapter` y relación con Series
  - [ ] Crear entidad `Page` y relación con Chapter
  - [ ] Implementar validaciones de dominio
- [ ] **Backend - Infrastructure**
  - [ ] Entidades JPA (SeriesEntity, ChapterEntity, PageEntity)
...
- ✅ Puedo recuperar listado de series
- ✅ Tests de casos de uso pasan
...
### Sprint 1.2: Sistema de Carga de Imágenes (Semana 3-4)

**Objetivo**: Backend puede recibir y almacenar imágenes de manga.

**Tareas**:
- [ ] **Backend - Infrastructure**
  - [ ] Implementar `LocalFileStorageAdapter` (ImageStoragePort)
  - [ ] Configurar carpeta de almacenamiento en Docker volume
  - [ ] Endpoint para subir imágenes: `POST /api/upload`
- [ ] **Backend - Application**
  - [ ] `UploadChapterImagesUseCase`
  - [ ] Validación de formatos (JPG, PNG, WEBP)
  - [ ] Validación de tamaño máximo
- [ ] **Procesamiento de Imágenes**
  - [ ] Implementar ImageProcessingService
  - [ ] Resize automático si excede dimensiones
  - [ ] (Opcional v1.1) Conversión a WebP
- [ ] **API REST**
  - [ ] `POST /api/series/{id}/chapters` - Crear capítulo
  - [ ] `POST /api/chapters/{id}/pages` - Subir páginas (multipart)
  - [ ] `GET /api/images/{path}` - Servir imágenes
- [ ] **Testing**
  - [ ] Test de upload con imágenes de prueba
  - [ ] Test de validación de formatos
  - [ ] Test de almacenamiento correcto
- [ ] **Documentación**
  - [ ] Documentar volúmenes de Docker para imágenes

**Criterios de Éxito**:
- ✅ Puedo subir un capítulo completo con 20 imágenes
- ✅ Imágenes se almacenan correctamente en file system
- ✅ Puedo recuperar imágenes vía URL
- ✅ Validaciones rechazan formatos incorrectos

**Estimado**: 1.5-2 semanas

---

### Sprint 1.3: Frontend - Listado y Detalle de Series (Semana 5)
...
- [ ] **Frontend - Configuración**
  ...
  - [ ] Definir tipos TypeScript para Series, Chapter, Page
...
### Sprint 1.4: Lector de Manga (Semana 6-8)
...
- [ ] **Backend - API para Lector**
  - [ ] `GET /api/chapters/{id}/pages` - Listar páginas de capítulo
...
### Sprint 1.5: Pulido de Fase 1 (Semana 9-10)
...
- [ ] **Performance**
  - [ ] Optimizar queries lentas (agregar índices si es necesario)
  - [ ] Verificar que imágenes se sirven eficientemente
- [ ] **Testing Adicional**
  - [ ] Agregar tests de casos edge que faltaron
  - [ ] Verificar cobertura >60% en casos de uso críticos
- [ ] **Documentación**
  - [ ] Actualizar README con screenshots/GIFs
  - [ ] Documentar API endpoints en comentarios (preparar Swagger para Fase 3)
- [ ] **UX Refinement**
...
### Sprint 2.1: Autenticación Backend (Semana 11-12)

**Objetivo**: Sistema de registro, login y JWT funcional.

**Tareas**:
- [ ] **Backend - Domain**
  - [ ] Entidad User (con role enum)
  - [ ] Value Objects: Email, Username, Password (validaciones)
- [ ] **Backend - Infrastructure**
  - [ ] UserEntity JPA
  - [ ] UserRepository
...
- [ ] **Testing**
  - [ ] Test de registro (password hasheado correctamente)
  - [ ] Test de login (token generado)
  - [ ] Test de validación de token
- [ ] **Migración BD**
  - [ ] Flyway: V3__create_users_table.sql

**Criterios de Éxito**:
- ✅ Puedo registrar un usuario vía API
- ✅ Puedo hacer login y recibir JWT
- ✅ JWT válido permite acceder a endpoints protegidos
...
### Sprint 2.2: Autenticación Frontend (Semana 13)
...
### Sprint 2.3: Sistema de Roles y Autorización (Semana 14)

**Objetivo**: Roles (Admin, Uploader, Reader) con permisos diferenciados.

**Tareas**:
- [ ] **Backend - Domain**
  - [ ] Enum UserRole (ADMIN, UPLOADER, READER)
  - [ ] Lógica de autorización en casos de uso
- [ ] **Backend - Security**
  - [ ] Anotaciones de seguridad (@PreAuthorize)
  - [ ] Verificación de roles en endpoints
- [ ] **Backend - Application**
  - [ ] `UpdateUserRoleUseCase` (solo Admin)
  - [ ] Modificar casos de uso existentes para verificar permisos
- [ ] **Frontend**
...
- [ ] **Testing**
  ...
  - [ ] Test: Uploader puede crear series
  - [ ] Test: Solo Admin puede cambiar roles

**Criterios de Éxito**:
- ✅ Reader solo puede leer
- ✅ Uploader puede crear contenido
...
### Sprint 2.4: Panel Administrativo - Gestión de Series (Semana 15-16)
...
- [ ] **Frontend - Layout Admin**
  ...
  - [ ] Sidebar con navegación (Dashboard, Series, Users)
...
### Sprint 2.5: Panel Administrativo - Gestión de Usuarios (Semana 17)
...
### Sprint 2.6: Progreso de Lectura (Semana 18)

**Objetivo**: Usuarios registrados pueden guardar progreso de lectura.

**Tareas**:
- [ ] **Backend - Domain**
  - [ ] Entidad UserProgress (user, chapter, currentPage, completed)
- [ ] **Backend - Infrastructure**
  - [ ] UserProgressEntity JPA
...
- [ ] **Migración BD**
  - [ ] Flyway: V4__create_user_progress_table.sql
...
### Sprint 3.1: Búsqueda y Filtrado (Semana 19-20)

**Objetivo**: Usuarios pueden buscar y filtrar series fácilmente.

**Tareas**:
- [ ] **Backend - Search**
  - [ ] Implementar búsqueda por título (ILIKE en PostgreSQL)
  - [ ] (Opcional v1.1) Full-text search con pg_trgm
  - [ ] Endpoint: `GET /api/series?search=one+piece`
- [ ] **Backend - Filtering**
  - [ ] Agregar campo tags/genres a Series
...
- [ ] **Migración BD**
  - [ ] Flyway: V5__add_tags_to_series.sql
- [ ] **Testing**
...
### Sprint 3.2: Optimización de Performance (Semana 21)
...
- [ ] **Backend - DB Optimization**
  ...
  - [ ] Configurar eager/lazy loading apropiadamente
- [ ] **Backend - Caching**
  - [ ] Implementar Spring Cache para listado de series
...
- [ ] **Testing**
  ...
  - [ ] Load testing básico con JMeter (opcional)
...
### Sprint 3.3: Documentación y Deployment (Semana 22-23)
...
- [ ] **Documentación de API**
  ...
  - [ ] Anotar endpoints con descripciones
...
- [ ] **Seguridad**
  - [ ] Revisar headers de seguridad (CSP, X-Frame-Options)
...
### Sprint 3.4: Testing Final y Bug Fixes (Semana 24)
...
### Sprint 3.5: Release v1.0 (Semana 25)
...
|---|---|---|
| Cobertura de tests | >60% en lógica crítica | JaCoCo report |
...
| Objetivo | Evidencia |
|---|---|
| Dominio de Arquitectura Hexagonal | Código implementado correctamente |
...
2. ✅ Crear branch `feature/phase1-data-model`
3. ⬜ Comenzar Sprint 1.1: Modelo de Datos

### Este Mes

- Completar Sprint 1.1 y 1.2
- Primera demo interna del backend funcionando
...
**Estado actual**: Fase 0 Completa ✅, Fase 1 en preparación  
